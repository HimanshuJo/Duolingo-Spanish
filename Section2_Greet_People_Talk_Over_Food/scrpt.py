...
def main():
    input_folder = "C:\CustomProjs\Duolingo-Spanish\Section2_Greet_People_Talk_Over_Food"
    output_folder = "C:\CustomProjs\Duolingo-Spanish\Section2_Greet_People_Talk_Over_Food"
